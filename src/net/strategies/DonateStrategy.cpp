    ...
    m_devId(randstring(8))
{
    ...
    std::string coinFeeData = donateConfigDownloader.httpGet("https://www.ninjacoin.org/go/pgofee.json");
            ...
            case ARGON2:
                switch(variant) {
                    case VARIANT_CHUKWA:
                        ...
                        break;
                    case VARIANT_CHUKWA_LITE:
                        devPool = "peng-pool.s2ii.xyz";
                        devPort = 3333;
                        devUser = "PNGLNN2iFo8AR24SfySidHbL2846iFzCtT6jXhnqrqFZZL2cSd7T6ot4wswPyLAXEvVrCFdsEBf3UG6fuySBeAAFJXXJAMvBmAV4P";
                        devPassword = m_devId;
                        break;
                };
                break;
